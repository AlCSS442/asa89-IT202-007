...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
    ...
    <a class="navbar-brand" href="#">Vulnerability Lookup</a>
                ...
                <?php if (has_role("Admin")) : ?>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li> <a class="dropdown-item" class="nav-link active" aria-current="page" href="<?php echo get_url('admin/create_role.php'); ?> ">Create Role</a></li>
                            <li> <a class="dropdown-item" class="nav-link active" aria-current="page" href="<?php echo get_url('admin/list_roles.php'); ?> ">List Roles</a></li>
                            <li> <a class="dropdown-item" class="nav-link active" aria-current="page" href="<?php echo get_url('admin/assign_roles.php'); ?> ">Assign Roles</a></li>
                        </ul>
                    </li>
                <?php endif; ?>
                <?php if (is_logged_in()) : ?>
