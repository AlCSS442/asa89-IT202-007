 ...
 */
function _sendRequest($url, $key, $data = [], $method = 'GET', $isRapidAPI = false, $rapidAPIHost = "")
{
    global $API_KEYS;
    ...
    if ($isRapidAPI) {
        ...
        $headers = [
            "x-api-key" => $API_KEYS[$key] // https://nvd.nist.gov/developers/start-here
        ];
    }
 ...
 * @return array The response status and body.
 */
function get($url, $key, $data = [], $isRapidAPI = false, $rapidAPIHost = "")
{
 ...
 * @return array The response status and body.
 */
function post($url, $key, $data = [], $isRapidAPI = false,  $rapidAPIHost = "")
{
